...
public class PortfolioSearchRepository {
    ...
    public List<PortfolioResDto> searchHairname(String hairName) {
        ...
        // QHairStyle hairStyle1 = QHairStyle.hairStyle;
        // QHairStyle hairStyle2 = QHairStyle.hairStyle;
        // QHairStyle hairStyle3 = QHairStyle.hairStyle;
        ...
        return new JPAQueryFactory(em)
            .select(Projections.constructor(PortfolioResDto.class,
                portfolio.user,
                portfolio,
                workImage,
                hairStyle1,
