...
public class PortfolioController {
    ...
    public ResponseEntity<PortfolioResDto> getPortfolio(HttpServletRequest httpRequest, Long portfolioId) {
        return ResponseEntity.ok(portfolioService.getPortfolio(httpRequest, portfolioId));
    }
